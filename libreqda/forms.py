...
from libreqda.models import Annotation, BooleanQuery, Category, Code, \
    Document, Project, Image, SemanticQuery, SetQuery, ProximityQuery
from libreqda.validators import DocumentValidator, ImageValidator
...
class CodeForm(forms.ModelForm):
    class Meta:
        ...
        exclude = ('citations', 'created_by', 'creation_date',
                   'modified_date', 'project', 'image_citations')
...
class CategoryForm(forms.ModelForm):
    class Meta:
        model = Category
        exclude = ('annotations', 'citations', 'image_citations', 'images', 'documents',
...
class UploadImageForm(forms.Form):
    ...
    comment = forms.CharField(required=False,
                              widget=forms.Textarea,
                              label='Comentario')
    share = forms.BooleanField(widget=forms.CheckboxInput(check_test='on'),
                               required=False,
                               label='¿Compartir imagen con otros usuarios y proyectos?')
